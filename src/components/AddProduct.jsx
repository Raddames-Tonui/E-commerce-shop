            ...
            <section className="bg-slate-200 dark:bg-gray-900">
                <div className=" px-4 mx-auto max-w-2xl lg:py-16">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-[#9745CD] hover:bg-[#58139A] rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                            Add product
                        </button>
                    </form>
                </div>
